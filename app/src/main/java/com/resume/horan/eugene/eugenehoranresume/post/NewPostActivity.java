...
public class NewPostActivity extends AppCompatActivity implements NewPostUploadFragment.TaskCallbacks, EasyPermissions.PermissionCallbacks {
    ...
    private NewPostUploadFragment mTaskFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTaskFragment = (NewPostUploadFragment) fm.findFragmentByTag(TAG_TASK_FRAGMENT);
        if (mTaskFragment == null) {
            mTaskFragment = new NewPostUploadFragment();
            fm.beginTransaction().add(mTaskFragment, TAG_TASK_FRAGMENT).commit();
        }

        mImageView = findViewById(R.id.new_post_picture);
        ...
        final EditText descriptionText = findViewById(R.id.new_post_text);

        mSubmitButton = findViewById(R.id.new_post_submit);
...
//                showProgressDialog(getString(R.string.post_upload_progress_message));
                ...
                String bitmapPath = "/" + FirebaseAuth.getInstance().getCurrentUser().getUid() + "/full/" + timestamp.toString() + "/";
                String thumbnailPath = "/" + FirebaseAuth.getInstance().getCurrentUser().getUid() + "/thumb/" + timestamp.toString() + "/";
                mTaskFragment.uploadPost(mResizedBitmap, bitmapPath, mThumbnail, thumbnailPath, mFileUri.getLastPathSegment(), postText);
            }
        });
    }
